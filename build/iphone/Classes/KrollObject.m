...
//@interface TabATNDObject : NSObject
//@end

@interface TabATNDObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TabATNDObject class]])
		{
			for (NSString *key in [[(TabATNDObject*)o modules] allKeys])
			{
