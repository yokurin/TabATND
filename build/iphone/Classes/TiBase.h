...
// in simulator we redefine to format for TabATND Developer console
...
{\
	NSString * exceptionName = [@"org.tabatnd." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tabatnd";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITabATNDNativeItemNone = -1, 
	UITabATNDNativeItemSpinner = -2,
	UITabATNDNativeItemProgressBar = -3,
	
	UITabATNDNativeItemSlider = -4,
	UITabATNDNativeItemSwitch = -5,
	UITabATNDNativeItemMultiButton = -6,
	UITabATNDNativeItemSegmented = -7,
	
	UITabATNDNativeItemTextView = -8,
	UITabATNDNativeItemTextField = -9,
	UITabATNDNativeItemSearchBar = -10,
	
	UITabATNDNativeItemPicker = -11,
	UITabATNDNativeItemDatePicker = -12,
	
	UITabATNDNativeItemInfoLight = -13,
	UITabATNDNativeItemInfoDark = -14,
	
	UITabATNDNativeItemDisclosure = -15,
	
	UITabATNDNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TabATND instances of
